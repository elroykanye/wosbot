...
public enum TemplatesEnum {
    ...
    NUMBER_7, NUMBER_8, NUMBER_9, NUMBER_10, FISHING_HOOK, FISHING_HOOK_BODY, FISHING_HOOK_RIGHT_FORK,
    FISHING_HOOK_RIGHT_FORK_PROTECTED,
    FISHING_PUFFERFISH, FISHING_REDFISH, FISHING_SMALLFISH, FISHING_STRIPEFISH,
    FISHING_HOME_ICON, FISHING_TITLE, FISHING_HAUL_TITLE, FISHING_ICE_BUTTON, FISHING_NORMAL_CAST,
    FISHING_NO_SPECIAL_ITEM, FISHING_PAUSE, FISHING_CONTINUE, FISHING_PAUSE_EXIT,
    FISHING_GO_FISH, CHIEF_ORDER_MENU_BUTTON,
